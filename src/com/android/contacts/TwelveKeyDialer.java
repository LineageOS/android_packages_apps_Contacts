        ...
        if (length > 0) {
            if (sT9Search != null) {
                ...
                if (result != null) {
                    ...
                    mT9Adapter.setNumber(mDigits.getText().toString());
                    if (mT9List.getAdapter() == null) {
                        mT9List.setAdapter(mT9Adapter);
                    }

                    if (mT9AdapterTop == null) {
                        mT9AdapterTop = new T9Adapter(this, 0, new ArrayList<ContactItem>(),getLayoutInflater());
                        mT9AdapterTop.setNotifyOnChange(true);
                    } else {
                        mT9AdapterTop.clear();
                    }
                    mT9AdapterTop.setNumber(mDigits.getText().toString());
