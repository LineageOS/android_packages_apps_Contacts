    ...
    private void configureAdapter() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                final View primaryIndicator = actionsContainer.findViewById(R.id.primary_indicator);
                final View securityIndicator = actionsContainer.findViewById(R.id.security_indicator);
