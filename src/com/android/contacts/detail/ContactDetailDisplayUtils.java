...
public class ContactDetailDisplayUtils {
     ...
     */
    public static boolean getActiveSession(Context context, String number) {
        ContentResolver resolver = context.getContentResolver();
        Cursor cursor =
                resolver.query(Uri.parse("content://org.whispersystems.whisperpush.sessionprovider"), null, null, new String[] {number},
                        null);
