...
public class QuickContactActivity extends ContactsActivity implements
    ...
    private boolean mSmsPermissionRequested = false;
        ...
        if (mSmsPermission != PackageManager.PERMISSION_GRANTED) {
            if (shouldShowRequestPermissionRationale(Manifest.permission.READ_SMS)) {
                ...
                Snackbar.make(mScroller, rs.getString(R.string.sms_permission_rationale),
                        ...
                        .setAction(rs.getString(R.string.sms_rationale_dismiss), new View
                                .OnClickListener() {
                            @Override
                            public void onClick(View v) {
                ...
                // if "Don't ask again" was chosen, requestPermissions does not prompt users
                if (!mSmsPermissionRequested) {
                    // only request once in one onResume lifecycle
