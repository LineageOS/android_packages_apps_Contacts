...
public class InCallMetricsHelper {
    ...
    public static Runnable prepareAndSend(final Context context, final InCallMetricsJobService
        ...
        Runnable sendTask = new Runnable() {
            @Override
            public void run() {
                if (!statsOptIn(context) || !checkAmbient(context)) {
    ...
    private static boolean checkAmbient(Context context) {
        return CyanogenAmbientUtil.isCyanogenAmbientAvailable(context) ==
