...
public class InCallMetricsSendTest {
    ...
    @Before
    public void setUp() {
        mActivity = (PeopleActivity) mActivityTestRule.getActivity();
        // Query plugins
    ...
    public void sendTest() {
        ...
        InCallMetricsHelper.prepareAndSend(mActivity);
    }

    private void populateMetricsInDb() {
        // Category: USER_ACTIONS
        // CONTACTS_MANUAL_MERGED
        InCallMetricsDbHelper.getInstance(mActivity).incrementUserActionsParam(
        ...
        InCallMetricsDbHelper.getInstance(mActivity).incrementUserActionsParam(
                ...
                InCallMetricsHelper.Parameters.COUNT.toCol());
        // INVITES_SENT
        InCallMetricsHelper.increaseCount(mActivity, InCallMetricsHelper.Events.INVITES_SENT,
                mCm.mComponent.flattenToString());
        // DIRECTORY_SEARCH
        InCallMetricsHelper.increaseCount(mActivity, InCallMetricsHelper.Events.DIRECTORY_SEARCH,
                mCm.mComponent.flattenToString());
